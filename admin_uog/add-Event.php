...
<head>
    ...
    <title>Add EVENTS | UOG Admin </title>
    ...
    <div class="all-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <h2 style="text-align: center;">Enter EVENT to-be-added details below</h2>
        ...
        if (isset($_POST["sub-but"])) {
            ...
            //if($name and $c and $t and $venue and $year and $start and $end and $begin and $close)
            {
                ...
                $querycheck = "SELECT * FROM events WHERE event_name= '" . $name . "' or category= '" . $cat . "' or type= '" . $type . "' or  venue_id= '" . $venue . "'  or begin_time= '" . $start . "' or end_time= '" . $end . "' or begin_date= '" . $begin . "' or end_date= '" . $close . "' or first_prize='" . $fp . "' or second_prize='" . $sp . "' or third_prize='" . $tp . "';";
