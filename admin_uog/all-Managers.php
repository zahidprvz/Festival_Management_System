...
<head>
  ...
  <title>All Managers | UOG Admin </title>
...
<body>
  ...
  <div class="all-content-wrapper">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> All Managers </span>
                      </li>
                    </ul>
                  </div>
                </div>
    ...
    if (!$result1 and !$result2) {
      print("<p>Result 1 and 2 not found!</p> ");
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="review-content-section">
                    <div class="row">
                      ...
                      <h4>There are <?php echo mysqli_num_rows($result2); ?> managers.</h4>
                      </p>
