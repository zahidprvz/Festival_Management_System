...
<head>
  ...
  <title>Add New Manager/Volunteer | UOG Admin </title>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="review-content-section">
                    <div class="row">
                      <p>
                      <h3 style="text-align: center;">The relation
                        <?php echo "Got " . mysqli_num_rows($result3) . " results."; ?>
                      </h3>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="review-content-section">
                        <div class="row">
                          ...
                          <caption>
                            <h4> Results of query - <?php print($select); ?> &nbsp; are :</h4>
                          </caption>
                          <p>
                          <table>
                            <?php
                            //fetch each record in result set
                            while ($row = mysqli_fetch_row($result3)) {  //build table to display results 
                              print("<tr>");
