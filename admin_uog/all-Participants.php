...
<head>
  ...
  <title>All Participants | UOG Admin </title>
  ...
  <div class="all-content-wrapper">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> All Participants </span>
                      </li>
                    </ul>
                  </div>
                </div>
    ...
    <div class="single-pro-review-area mt-t-30 mg-b-15" id="work-area">
      <div class="container-fluid">
        ...
        <h4>Total PARTICIPANTS till now is <?php echo mysqli_num_rows($result2); ?></h4>
        </p>
