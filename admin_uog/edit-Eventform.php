...
<head>
    ...
    <title>Edit Event | UOG Admin </title>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index_new.php"><img class="main-logo" src="img/uog-logo.png" height=300 width=100 alt="Go to index page" /></a>
                <strong><a href="index_new.php"><img src="img/uog-logo.png" height=300 width=100 alt="Go to index page" /></a></strong>
            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <div style="text-align: center;">
                                <h2>Enter EVENT to-be-edited details below</h2>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <h3> Event Id: </h3>
                                                                    <input name="ev_id" type="number" class="form-control" placeholder="Event Id">
                                                                </div><br><br>
                                                                <div class="form-group">
                                                                    <h3> Event Name: </h3>
                                                                    <input name="ev_name" type="text" class="form-control" placeholder="Event Name">
                                                                </div><br><br>
                                                                <div class="form-group">
                                                                    <h3> Category: </h3>
                                                                    <select name="ev_cat" class="form-control">
                                                                ...
                                                                <div class="form-group">
                                                                    <h3> Type: </h3>
                                                                    <select name="ev_type" class="form-control">
                                                                ...
                                                                <div class="form-group">
                                                                    <h3> Venue: </h3>
                                                                    <input name="ev_venue" type="text" class="form-control" placeholder="Event Venue/Location">
                                                                </div><br><br>
                                                                <div class="form-group">
                                                                    <h3> First prize: </h3>
                                                                    <input name="fp" type="number" class="form-control" placeholder="first prize amount">
                                                                </div><br><br>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <h3> Start Time: </h3>
                                                                    <input name="ev_start" type="time" class="form-control" placeholder="Starting time of event - hh:mm:ss">
                                                                </div><br><br>
                                                                <div class="form-group">
                                                                    <h3> End Time: </h3>
                                                                    <input name="ev_end" type="time" class="form-control" placeholder="Ending time of event - hh:mm:ss">
                                                                </div><br><br>
                                                                <div class="form-group">
                                                                    <h3> Begin Date: </h3>
                                                                    <input name="ev_begin" type="date" class="form-control" placeholder="Beginning Date of event - DD/MM/YYYY">
                                                                </div> <br><br>
                                                                <div class="form-group">
                                                                    <h3> Closing Date: </h3>
                                                                    <input name="ev_close" type="date" class="form-control" placeholder="Closing date of event - DD/MM/YYYY">
                                                                </div> <br><br>
                                                                <div class="form-group">
                                                                    <h3> Second prize: </h3>
                                                                    <input name="sp" type="number" class="form-control" placeholder="second prize amount">
                                                                </div><br><br>
                                                                <div class="form-group">
                                                                    <h3> Third prize: </h3>
                                                                    <input name="tp" type="number" class="form-control" placeholder="third prize amount">
                                                                </div><br><br>
                                                                <br><br>
                                                            </div>
                                                        </div><br><br>
