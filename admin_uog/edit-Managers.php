...
<head>
  ...
  <title>Edit Manager | UOG Admin </title>
  ...
  <div class="all-content-wrapper">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> Edit Manager </span>
                      </li>
                    </ul>
                  </div>
                </div>
    ...
    <div class="single-pro-review-area mt-t-30 mg-b-15" id="work-area">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st" style="text-align: center;">
              <h2>Enter details below which is to be edited.</h2>
            </div>
                        ...
                        <form method="POST" action=edit-Relations.php>
                          <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div class="form-group">
                                <h3> Event Id: </h3>
                                <input name="eventid" type="number" class="form-control" placeholder="Number part of Event Id ">
                              </div><br><br>
