...
<head>
  ...
  <title>Pdf Viewer | UOG Admin </title>
    ...
    function button_click() {
      ...
      if (seePdf != " ") {
        ...
        clone.setAttribute('src', "pdf\"+seePdf); "
          ...
          alert("Please Enter a .pdf or .txt file name with extension, that is present in 'pdf' folder ")
        }
      }
  </script>
...
<body>
  ...
  <div class="all-content-wrapper">
    ...
    <!-- Middle area to take file as input that is to be shown -->
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div>
            <h2 align="center"> Enter the document(.txt/.pdf) &nbsp;you want to view <br> That &nbsp; document &nbsp; must be in &nbsp;'pdf'&nbsp; folder </h2><br><br>

            <div class="row">
              <div>
                <div>
                  <div>
                    <form align='center' action="viewpdf.php" method="POST">
                      <div class="row">
                        <div>
                          <input type='text' id='to-view' name="pdfname" placeholder="Enter .pdf/.txt file name "></input>
                        </div>
                      </div><br><br>

                      <div class="row">
                        <div>
                          <button type="submit" name="sub" class="btn btn-primary waves-effect waves-light" onclick=button_click()>Submit</button>
                        </div>
                      </div>
