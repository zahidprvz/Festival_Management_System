...
<head>
  ...
  <title>Delete from Relations | UOG Admin</title>
  ...
  <div class="all-content-wrapper">
    ...
    if (isset($_POST["sub-but"])) {
      ...
      if (isset($id) and isset($pname)) {
        ...
        } else if ($table == "participants") {  //query UOG database
