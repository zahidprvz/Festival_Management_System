...
<head>
  ...
  <title>Edit Sponsor | UOG Admin </title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> Edit Sponsor </span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st">
              <div style="text-align: center;">
                <h2>Enter Sponsor details below that are to be edited.</h2>
              </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="review-content-section">
                        <div class="pro-ad">
                          <form method="POST" action=edit-Relations.php>
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                  <h3> Relation/Table Name: </h3>
                                ...
                                <div class="form-group">
                                  <h3> Id(only numeric part) :</h3>
                                  <input name="id" type="number" class="form-control" placeholder="Enter that Id where row is to be updated">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Full Name of Sponsor/Organisation/Company: </h3>
                                  <input name="firstname" type="text" class="form-control" placeholder="Full Name">
                                </div><br><br>
                                <div class="form-group">
                                  <H3> Grade: </H3>
                                  <select name="gr" class="form-control">
                                    <option value="0" selected=""> Diamond | Range</option>
                                    <option value="1"> Platinum | Range</option>
                                    <option value="2"> Gold| Range</option>
                                    <option value="3"> Other category </option>
                                  </select>
                                </div> <br><br>
                                <div class="form-group">
                                  <h3> Representative Name: </h3>
                                  <input name="rep" type="text" class="form-control" placeholder="Representative Name">
                                </div><br><br>
                              </div>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  <h3> Amount Sponsored in (INR) : </h3>
                                  <input name="amt" type="number" class="form-control" placeholder="Amount Sponsored">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Account No. of Sponsor/Organisation/Company : </h3>
                                  <input name="acc" type="varchar" class="form-control" placeholder="Account Number of Sponsor/Organisation/Company">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Contact No. : </h3>
                                  <input name="mobileno" type="number" class="form-control" placeholder="Contact no.">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Email Id : </h3>
