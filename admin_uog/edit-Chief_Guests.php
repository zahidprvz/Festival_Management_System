...
<head>
  ...
  <title>Edit Chief Guests | UOG Admin </title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> Edit Chief Guest </span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st">
              <div style="text-align: center;">
                <h2>Enter Chief Guest's details below that are to be edited.</h2>
                <br><br>
              </div>
                        ...
                        <div class="pro-ad">
                          <form method="POST" action="edit-Relations.php">
                            <div class="row">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                  <h3> Social Media URL/LinkedIn/Link : </h3>
                                  <input name="sm-link" type="text" class="form-control" placeholder="LinkedIn/Facebook/Instagram/Twitter OR Any other social media link OR URL">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Contact No. : </h3>
