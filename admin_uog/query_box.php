...
<head>
  ...
  <title> Query Box | UOG Admin </title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> Query Box </span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st">
              <div style="text-align: center;">
                <h2>Have your own MySQL query or want to see some other data from relation?<br>Type your MySQL query in the query box below</h2>
              </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="review-content-section">
                        <div class="pro-ad">
                          <form method="POST" action="query_box_run.php">
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class='form-group'>
                                  <h3> Enter your Query: </h3> <br>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                  <h3> Some available Queries may work for you:</h3>
                                  <iframe src="queries.txt" width='100%' height="500" frameborder="0" allowfullscreen sandbox>
                                    <p>
                                      <a href="queries.txt">Fallback link for browser </a>
                                    </p>
                                  </iframe>
                                </div><br><br>
