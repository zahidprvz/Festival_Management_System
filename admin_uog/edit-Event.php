...
<head>
  ...
  <!-- favicon
		============================================ -->
  <link rel="shortcut icon" type="image/x-icon" href="img/uog-logo.JPG"> <!-- icon shown on top of heading of admin page -->
  <!-- Google Fonts
		============================================ -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="review-content-section">
                    <div class="row">
                      ...
                      <caption>
                        <h4> Row earlier :- &nbsp; <br> <?php print($query_check . " .    "); ?></h4><br>
                      </caption>
                      <p>
                      <table>
                        ...
                        while ($row = mysqli_fetch_row($resultcheck)) {  //build table to display results 
                          print("<tr>");
                    ...
                    <div class="row">
                      <!-- <div class="col-lg-6 col-md-10 col-sm-10 col-xs-12"> -->
                      <caption>
                        <h4> Updated row on executing query - <?php print($new); ?> &nbsp; :</h4>
                      </caption><br>
                      <p>
                      <table>
                        <?php
                        while ($row = mysqli_fetch_row($result)) {  //build table to display results 
                          print("<tr>");
