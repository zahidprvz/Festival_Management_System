...
<head>
  ...
  <title> Add Volunteer Details | UOG Admin</title>
...
<body>
  ...
  <div class="all-content-wrapper">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> To add Volunteer </span>
                      </li>
                    </ul>
                  </div>
                </div>
    ...
    <!--  Middle area to take details of Volunteer to be added  -->
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st">
              <div style="text-align: center;">
                <h2>Enter Volunteer details below that are to be added.</h2>
                <br><br>
              </div>
                          ...
                          <form method="POST" action="add-Man_Vol.php">
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  <h3> Volunteer's Full Name: </h3>
                                  <input name="firstname" type="text" class="form-control" placeholder="Volunteer's Full Name">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Gender: </h3>
