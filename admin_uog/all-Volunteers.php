...
<head>
  ...
  <title>All Volunteers | UOG Admin </title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> All Volunteers </span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st"> <!--Gives space between i/p box and left-end of white background of form -->
              <div class="row">
                ...
                <h4>The Relation VOLUNTEERS has <?php echo mysqli_num_rows($result2); ?> rows.</h4>
                </p>
