...
<head>
  ...
  <title>Add Manager Details | UOG Admin </title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> To Add Manager </span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st">
              <div style="text-align: center;">
                <h2>Enter Manager details below that are to be added.</h2>
                <br><br>
              </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="review-content-section">
                        <div class="pro-ad">
                          <form method="POST" action="add-Man_Vol.php">
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                  <h3> Work Designation: </h3>(Enter in format as written below)
                                  <select name="work-Tag" class="form-control">
                                    <option value="1" selected="">Manager</option>
                                  </select>
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Manager's Full Name: </h3>
                                  <input name="firstname" type="text" class="form-control" placeholder="Manager's Full Name">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Gender: </h3>
                                  <select name="gender" class="form-control">
                                    <option value="0" selected="">Not disclosable</option>
                                ...
                                <div class="form-group">
                                  <h3> Event Id: </h3>
                                  <input name="eventid" type="number" class="form-control" placeholder="Numeric part of Event Id ">
                                </div><br><br>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                  <h3> Branch: </h3>
                                  <input name="br" type="text" class="form-control" placeholder="Branch">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Year: </h3>
                                  <input name="yr" type="number" class="form-control" placeholder="Year">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Contact No. : </h3>
