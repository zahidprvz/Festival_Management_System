...
<head>
  ...
  <title>All Chief Guests | UOG Admin </title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> All CHIEF GUESTS </span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="review-content-section"> <!--Creates white boundary for form area-->
                    <p>
                    <h4 align="center"> The Relation CHIEF_GUESTS has
                      <?php print(mysqli_num_rows($result2)) ?> rows. </h4>
                    </p>
                    <div class="row">

                      <div class="col-lg-6 col-md-10 col-sm-10 col-xs-12">
                        <caption>
                          <h4> Results of query - <?php print($query1); ?> &nbsp; are:</h4>
                        </caption><br>
                        <p>
                        <table>
                          <?php
                          while ($row = mysqli_fetch_row($result1)) {  //build table to display results 
                            print("<tr>");
