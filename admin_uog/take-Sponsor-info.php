...
<head>
  ...
  <title>Add Sponsors Details | UOG Admin</title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> To add Sponsor </span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st">
              <div style="text-align: center;">
                <h2>Enter Sponsor details below that are to be added.</h2>
                <br><br>
              </div>
                            ...
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                  <h3> Special Designation:</h3>(Enter in format as written below)
                                  <select name="special-Tag" class="form-control" ">
                                                                        <option value=" 2" selected="">Sponsor</option>

                                  </select>
                                </div><br><br>
                                <div class="form-group">
                                  <h3>Organisation/Sponsor Full Name: </h3>
                                  <input name="firstname" type="text" class="form-control" placeholder="Organisation/Sponsor Full Name">
                                </div><br><br>
                                <div class="form-group">
                                  <h3> Grade: </h3>
                                  <select name="grade" class="form-control">
                                    <option value="0" selected=""> Diamond | To-from</option>
                                    <option value="1"> Platinum | To-from</option>
                                    <option value="2"> Gold | To-from</option>
                                    <option value="3"> Other</option>
                                  </select>
                                </div> <br><br>
                                <div class="form-group">
                                  <h3> Amount sponsored(PKR) : </h3>
                                  <input name="amt" type="number" class="form-control" placeholder="Amount sponsored in Rs.">
                                </div><br><br>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                  <h3> Representative Name To Be Contacted : </h3>
                                  <input name="rep-name" type="text" class="form-control" placeholder="Representative Name:">
                                </div><br><br>
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="acc-no" type="text" class="form-control" placeholder="Account Number">
                                </div><br><br>
                                <br><br>
                              </div>
                            </div><br><br>
