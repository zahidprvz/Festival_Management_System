...
<head>
  ...
  <title>All Sponsors | UOG Admin </title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> All Sponsors </span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="review-content-section"> <!--Creates white boundary for form area-->
                    <div class="row">
                      ...
                      <h4>We have a total of <?php echo mysqli_num_rows($result2); ?> sponsors.</h4>
                      </p>
