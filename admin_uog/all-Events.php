...
<head>
  ...
  <title>All Events | UOG Admin </title>
  ...
  <style>
    /* Add this CSS to style the table and content */
...
<body>
  ...
  <div class="all-content-wrapper">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod"> Events Schedule </span>
                      </li>
                    </ul>
                  </div>
                </div>
    ...
    <div class="single-pro-review-area mt-t-30 mg-b-15" id="work-area">
      <div class="container-fluid">
        <!-- Creates a white box on which form's input boxes are there-->
        <p style="text-align: center;">
        <h4>Total Events till now are <?php echo mysqli_num_rows($result2); ?></h4>
        </p>
                  ...
                  <div class="review-content-section"> <!--Creates white boundary for form area-->
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-10 col-sm-10 col-xs-12">
                        <caption>
                          <h4> Results of query - <?php print($query2); ?> &nbsp; are:</h4>
                        </caption> <br>
                        <p>
                        <table>
                          <?php
                          //fetch each record in result set
                          while ($row = mysqli_fetch_row($result2)) {  //build table to display results 
                            print("<tr>");
  ...
  <!--  
        <div class="calender-area mg-b-50" >
          <div class="container-fluid">
              <div class="row">
                  <div class="col-lg-12" id = "work-area">
                      <div class="calender-inner">
                          <div>
                          <iframe src="https://calendar.google.com/calendar/embed?src=0afb82732a51190a6785b8725b4203d1a27c2b5b7684b10870a490cbb8078191%40group.calendar.google.com&ctz=UTC" style="border: 0" width="1000" height="600" frameborder="0" scrolling="no"></iframe>													 
            </div>
                      </div>
                  </div>
              </div>
