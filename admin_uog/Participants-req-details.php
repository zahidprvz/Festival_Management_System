...
<head>
  ...
  <title>Participants Required details | UOG Admin </title>
                  ...
                  <div class="review-content-section">
                    <div class="row">
                      <div style="text-align: center;" class="row">
                        <caption>
                          <h4>Total participants registered till now are:</h4>
                        </caption>
                      </div>
                      ...
                      <table>
                        ...
                        while ($row = mysqli_fetch_row($count_result)) {  //build table to display results 
                          print("<tr>");
                    ...
                    <div class="col-lg-6 col-md-10 col-sm-10 col-xs-15" style="text-align: center;">
                      <caption>
                        <h4>Results of query - <?php echo $query1; ?> are:</h4>
                      </caption>
                      <br>
                      <p>
                      <table>
                    ...
                    <div class="col-lg-6 col-md-10 col-sm-10 col-xs-15" style="text-align: center;">
                      <caption>
                        <h4>Results of query - <?php echo $req; ?> are:</h4>
                      </caption>
                      <br>
                      <p>
                      <table>
