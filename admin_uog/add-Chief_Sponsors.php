...
<head>
    ...
    <title>Add Chief Guest/Sponsor | UOG Admin</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="img/uog-logo.png">   <!-- icon shown on top of heading of admin page -->
    <!-- Google Fonts
		============================================ -->
     ...
     <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index_new.php"><img class="main-logo" src="img/uog-img.jpg" height = 300 width = 100 alt="Go to index page" /></a>
                <strong><a href="index_new.php"><img  src="img/uog-img.jpg" height = 300 width = 100 alt="Go to index page"/></a></strong>
            </div>
    ...
    <div class="all-content-wrapper" >
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod"> Add Sponsor or Chief Guest </span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
		...
		<?php
			...
			if(isset($_POST["sub-but"]))
			{
				...
				// $passwd = "DK@uog" ; //password according to useraccount created in database
        // $schema = "uog" ; // to store database/schema wheree all relations are present
        include "linc.php";
				
				$s = $_POST["special-Tag"] ;  // to identify whether it's Chief-Guest or a Sponsor
				$pname = $_POST["firstname"] ;  // to store name of Sponsor/Organisation(in Sponsor table) or of Chief-Guest(in Chief_Guests table)
				$phone =$_POST["mobileno"] ;  // to store contact no. 
        $email =$_POST["emailid"] ;  // to store email-id
        switch($s)
        {
          case 1:
            $special="cguest";
          ...
          case 2:
			...
			{
				die("Form not submitted properly!!!</body></html> ") ;
			}
				...
				if($special =="cguest" ) 
				{
					$sm_url = $_POST["link"] ;  //to store social media/LinkedIn link or any other url
					$g = $_POST["gender"] ;   /// to store gender of Chief-Guest
					switch($g)
					{
						case 0:
								$gen = "ND" ;
					...
					$query_in = "INSERT INTO ".$special." VALUES ('' ,'" .$pname. "' ,'". $gen . "' ,'". $phone . "' ,'". $email."' ,'". $sm_url. "' ) ;"   ;
				
				}
				
				
				else if($special== "sponsor" )
					{
						$amount = $_POST["amt"] ;  //to store amount sponsored
						$acc_num = $_POST["acc-no"] ;  // to store account number of Sponsor
						$representative = $_POST["rep-name"] ;   //to store representative name of Sponsor
						$year = $_POST["yr"] ;
						$g = $_POST["grade"] ; // to store grade of Sponsor: Alpha-"A", Beta-"B", Gamma-"G", any other grade-"O"
						switch($g)
						{
							case 0:
									$gr = "D" ;
						...
						//Query to insert input data into Sponsors table
						$query_in = "INSERT INTO ".$special." VALUES ('' ,'" .$pname. "' ,'".$amount. "' ,'".$gr."' ,'" . $email."' ,'".$acc_num."' ,'". $representative. "' ,'".$phone."'  ) ;"   ;               
					}
			...
			$query1 = "DESC ".$special." ;" ;  // to describe a relation
			$select = "SELECT * FROM ".$special." ;" ; // to print complete relation
		...
		// 	}
			...
			if(!$result1 and !$result3 )           //To check whether relation exists or not, in database
				{  print("<p>Could not get result 1 and result 3!</p> ") ;
		...
		<div class="single-pro-review-area mt-t-30 mg-b-15" id="work-area">
            <div class="container-fluid"> <!-- Creates a white box on which form's input boxes are there-->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st"> <!--Gives space between i/p box and left-end of white background of form -->
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section"> <!--Creates white boundary for form area-->
                                        <div class="row">
                                        <p>
                                        <h4 style="text-align: center;">Total&nbsp;<?php echo $special; ?>&nbsp;are 
                                          <?php echo mysqli_num_rows($result3); ?></h4>

                                <!-- prints number of rows in relation Sponsors/Chief_Guests-->
								</p>
											<?php echo("<H2 align='center'>Adding given details in <strong>".$special."</strong> </H2> "); ?><br><br><br><br>
                                            <div class="col-lg-6 col-md-10 col-sm-10 col-xs-12">
												<p><br>
													<caption><h4> Results of query - <?php  print($query1); ?> &nbsp; are:</h4></caption> <br>
														<table> <!-- prints result of query 1 in tabular format -->
															<?php 
											...
											<div class="col-lg-6 col-md-10 col-sm-10 col-xs-15">   
												<caption><h4> Results of query - <?php  print($select); ?> &nbsp;are: </h4></caption><br>
												<p> <br>
														<table>   <!-- prints result of query2 in tabular format -->
															<?php  
