...
<body
    ...
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span
            class="text-primary site-heading-upper mb-3"> Presented by Baila-Amor, Dance society of UOG&nbsp;</span>
        ...
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/solodance.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    ...
                    <p class="mb-3">Are u a passionate solo dancer . Come to UOG and show your worth!!
                        <h6><br><b>VENUE-</b>
                            <?php
                                include "linc.php";
        ...
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/groupdance.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    ...
                    <p class="mb-3">Love Dancing in groups? Come to UOG and engage all others to enjoy!!
                        <h6><br><b>VENUE-</b> <?php
                                include "linc.php";
