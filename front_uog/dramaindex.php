...
<body
    ...
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span
            class="text-primary site-heading-upper mb-3"> Presented by Abhinay, Drama society of UOG&nbsp;</span>
        ...
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/solodrama.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    ...
                    <p class="mb-3">UOG has everything for you- from drama competitions ,monoacts to standup comedies to on-the-spot-monoacters
                        <h6><br><b>VENUE-</b><?php
                                include "linc.php";
        ...
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/groupdrama.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    ...
                    <p class="mb-3">ave a nitch of acting ?  See urself as an actor/performer/artist /comedian  ? <br>UOG has everything for you- from drama competitions.
                        <h6><br><b>VENUE-</b><?php
                                include "linc.php";
