...
<div class="row">
    ...
    <h1>Registration form of Vartalaap</h1>
    <div class="container">
        <form action="" method="POST">
            <h1>Please enter the fields to register in Vartalaap-UOG</h1>
    ...
    if($tright==1)
    {
        if($mright==$i)
        {
            foreach ($user as $u)
            {
                ...
                // $pw=mysqli_real_escape_string($mysqli,$u['password']);
                $t_id=mysqli_real_escape_string($mysqli,$_POST["tname"]);
                $query2="insert into t_participation (t_id,p_id,e_id) values('$t_id','$p_id',6);";
            ...
            if($j==$i)
            {
                echo "<script>alert('Succesfully registered your team in Vartalaap')</script>";
            }
