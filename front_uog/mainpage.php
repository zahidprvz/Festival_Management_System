        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-10 col-lg-4">
              ...
              <!-- to go to SE website -->
                <a href="https://www.uog.edu.pk">University of Gujrat 
                    presents</a>
            ...
            <div class="col-2 col-lg-8">
              <nav class="site-navigation">
                ...
                <!-- nav bar URLS to go to different pages -->
                  ...
                  <li><a href="plogin.php">My Account</a></li>
...
<!-- sponsors begin -->
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="copyright-info">
                ...
                <a href="mainpage.php" target="_blank">Zahid</a>
              </div>

              <div class="footer-social">
                <ul class="flex justify-content-center align-items-center">
                  <li>
                    <a href="https://web.facebook.com/UniversityofGujrat/?_rdc=1&_rdr"><i class="fab fa-facebook-f"></i></a>
                  </li>
                  <li>
                    <a href="https://twitter.com/i/flow/login?redirect_after_login=%2FUOGPK"><i class="fab fa-twitter"></i></a>
                  </li>
                
                  <li>
                    <a href="https://www.linkedin.com/company/396177"><i class="fab fa-linkedin-in"></i></a>
                  </li>
                  <li>
                    <a href="http://mail.uog.edu.pk/"><i class="fab fa-email"></i></a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    // script for countdown
      ...
      var countDownDate = new Date("August 18, 2023 23:59:59").getTime();
