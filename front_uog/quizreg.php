...
<div class="row">
    ...
    <h1>Registration Form of Quiz</h1>
    <div class="container">
        <form action="" method="post">
            <h1>Please enter the field to register in Quiz-UOG</h1>
...
if (isset($_POST["sub"])){
    ...
    if(mysqli_num_rows($result)==1){
        $q="select * from participation where p_id='$p_id' and event_id=5";
        $r=mysqli_query($mysqli,$q);
        if(mysqli_num_rows($r)==0)
        {   //checking for already registered or not
            $query2="insert into participation (p_id,event_id) values('$p_id',5)";
        ...
        {
            echo "<script>alert('You have already registered in Quiz')</script><br>";
        }
