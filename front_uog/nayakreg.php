...
<div class="row">
    ...
    <h1>Registration Form of NAYAK</h1>
    <div class="container">
        <form action="" method="post">
            <h1>Please enter the field to register in NAYAK-UOG</h1>
...
if (isset($_POST["sub"])){
    ...
    if(mysqli_num_rows($result)==1){
        $q="select * from participation where p_id='$p_id' and event_id=8";
        $r=mysqli_query($mysqli,$q);
        if(mysqli_num_rows($r)==0)
        {   //checking for already registered or not
            $query2="insert into participation (p_id,event_id) values('$p_id',8)";
        ...
        {
            echo "<script>alert('You have already registered in Nayak')</script><br>";
        }
