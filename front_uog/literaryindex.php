...
<body
    ...
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span
            class="text-primary site-heading-upper mb-3"> Presented by Perspectives, Debating society of UOG&nbsp;</span>
        ...
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/debate.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    ...
                    <p class="mb-3">Have a talent to put your views in front of world. <br> Then why wait for discussions ? Come here and break the mikes, take people far away from what they believe  !!  
                        <h6><br><b>VENUE-</b> <?php
                                include "linc.php";
